...
[6] align_manuscript.py      → v11_aligned.docx
        ↓
[7] update_docx.py           → manuscript_revised.docx
        ↓
[8] _build_v14.py            → manuscript_v14_4tiers.docx  (final)
```
...
## Skenario 7 — Update Manuskrip Final (→ _revised.docx)
...
## Skenario 8 — Build Manuskrip Final v14 (4 Tier)
...
## Skenario 9 — Inspeksi Cepat Hasil
